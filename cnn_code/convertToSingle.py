...
DO_MNIST = False
DO_SPECTRO_1024 = True
DO_SPECTRO_512 = False
...
#now do spectro 1024
if DO_SPECTRO_1024:
	print("Starting 1024 spectro")
	activations = np.loadtxt(open("featureVector/cnnLastLayerVal1024NEW.txt"))
	print(activations.shape)
	values = np.loadtxt(open("featureVector/cnnActualYVal1024NEW.txt"))
	print(values.shape)
	# print(values[:10])
	for i in xrange(10):
...
if DO_SPECTRO_512:
	print("starting 512")
	activations = np.loadtxt(open("featureVector/cnnLastLayerVal512NEW.txt"))
	print(activations.shape)
	values = np.loadtxt(open("featureVector/cnnActualYVal512NEW.txt"))
	print(values.shape)
	# print(values[:10])
	for i in xrange(10):
		print(np.argmax(values[i]),end=" ")
